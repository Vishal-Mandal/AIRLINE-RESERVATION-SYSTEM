...
$res ="select * from registrationforrm where Email = '".$i."'";
$num = mysqli_query($con, $res);    
    ...
    if ($val > 1){
        echo "Email Already Exist !";
         ...
         $tot = "insert into registrationform values ( '".$a."','".$b."','".$c."','".$d."','".$e."','".$f."','".$g."','".$h."','".$i."','".$j."','".$k."')";
          mysqli_query($con, $tot) or die('Error Quering Database.');
...
<div class="signup">
    <h1 style="color: #f64747;"> REGISTRATION FORM </h1>
...
<form name="RegistrationForm" action="" onsubmit="return FormData()" method="POST" class="form">
    ...
    <h2 class="text">Contact details</h2>
      ...
      <p ID="phone">Telephone: <input type="number" size=65 name="Telephone" min="0" placeholder="Enter your number"></p>
